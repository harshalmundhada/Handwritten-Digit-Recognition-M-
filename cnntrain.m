function [missimages, misslabels] = cnntrain(trainlabels,trainimages,testlabels,testimages,maxtrain,iter,eta,start)
...
disp(['Miss: ' num2str(miss) ' out of ' num2str(10)]);
ind
display_network(images(:,start:numtest));
end
